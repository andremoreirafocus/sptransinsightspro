...
def test_returns_dataframe():
    ...
    result = load_trip_details(
        make_config(), get_duckdb_connection_fn=lambda _conn: fake_con
    )
...
def test_connection_closed_after_success():
    ...
    fake_con = FakeDuckDBConnection(df=df)
    load_trip_details(make_config(), get_duckdb_connection_fn=lambda _conn: fake_con)
