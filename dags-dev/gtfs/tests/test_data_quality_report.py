...
def test_save_quality_report_calls_write_fn_with_single_object_name():
    calls = []

    def fake_write(connection_data, buffer, bucket_name, object_name):
        calls.append((bucket_name, object_name))

    path = save_data_quality_report_to_storage(
        config=_config(),
        data_quality_report={"summary": {"status": "PASS"}, "details": {}},
