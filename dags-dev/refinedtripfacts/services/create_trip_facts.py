        ...
        with engine.begin() as conn:
            result = conn.execute(
                text(
                    ...
                    f"        is_circular, distance_meters, avg_speed_kmh,"
                    f"        to_char(trip_start_time AT TIME ZONE 'America/Sao_Paulo', 'YYYYMMDDHH')::int AS started_at_time_dim_key,"
                    f"        to_char(trip_end_time AT TIME ZONE 'America/Sao_Paulo', 'YYYYMMDDHH')::int AS ended_at_time_dim_key,"
                    f"        logic_date"
                    f"    FROM src"
