...
with DAG(
    ...
    save_to_storage_trusted_task = PythonOperator(
        task_id="save_to_storage",
        python_callable=save_to_storage,
    )

    load_from_raw_task >> transform_positions_task >> save_to_storage_trusted_task
